...
/**
 * BaseModel class implements basic CRUD ops from {@link Cassandra.Model.AbstractModel}
 */
...
class AbstractModel {
    ...
    findOne(queryObject, projection, options, callback) {
        ...
        AbstractModel.prototype.find.call(this, queryObject, projection, options, (err, result) => {
            if (result) {
                result = result.shift();
            }
            callback(err, result);
