...
const CassandraDriverUtils = require('cassandra-driver/lib/utils');
...
class Cassandra {
    ...
    model(name, schema, callback) {
        var cassandra = this;
        var modelInstance = new Cassandra.Model(cassandra, name, schema, callback);
...
Cassandra.utils = CassandraDriverUtils;
